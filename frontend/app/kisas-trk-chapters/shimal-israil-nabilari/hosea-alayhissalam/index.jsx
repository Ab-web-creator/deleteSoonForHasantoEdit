...
export default function HoseaAlayhissalam() {
  return (
    <main className="stories relative">
      ...
      <div className="font-amiri text-center">
        ...
        <p className="mt-0">(Rad 38)</p>
      </div>

      <div>
        <p>
          Efrayim aşiretinin mesken kurduğu yöredeki Samiriye bölgesi, Asur kavmi
          tarafından fethedilmeden evvel hükümdar Yarovam devrinde, Allah-u Teâlâ
          Hz. Hoşea(as)’ya seslenip;
        </p>

        <p className="boldItalic">
          “Ey Hoşeya git bir fahişe ile evlen, ondan evlatların olsun. Zira bu
          kavim dahi benden uzaklaşıp zina etmektedir”
        </p>
        ...
        <p>
          Allah-u Teâlâ&apos;nın bu emri vermesinde hikmet-i sebebi şuydu ki;
          İsrailoğullarının bir fahişe gibi olduğunu göstermektir. Allah-u Teâlâ
          İsrailoğullarını seçmiş, onlara merhamet göstermişti ancak bir fahişe
          nasıl ki her seferinde kocasını aldatır, başka erkeklerin ardından gider
          aybı şekilde de İsrailoğulları her seferinde başka ilahların ardından
          gidip onlara kulluk ederek fahişe gibi davranıyordu. Bu sebepten izzet
          ve hikmet sahibi Allah-u Teâlâ İsrailoğullarının günahlarına ayna tutmak
          için Hz. Hoşea(as)&apos;a bunu buyurdu.
        </p>

        <p>
          Hz. Hoşea(as) emrolunduğu üzere gidip Gomer adında bir fahişeyle evlendi
          ondan evladı olunca, ismini Yizreel (Allah bertaraf edecek) koydu, çünkü
          Allah-u Teâlâ o yörede dökülen kanların hesabını soracağından,
          İsrailoğullarını darmadağın edecekti. Hz. Hoşea(as)’nın tekrar evladı
          oldu, ismini Lo-Ruhama (Rahmet edilmeyecek) koydu, çünkü Allah-u Teâlâ
          İsrailoğullarına acımayacak suçlarına mağfiret etmeyecekti. Ancak Yahuda
          diyarında ikamet edenlere merhamet edip onları özgür kılacağına yemin
          etti. Hz. Hoşea(as)’nın bir evladı daha oldu, ismini Lo-Ammi (Artık
          kavmim değil) koydu zira İsrail kavmi Allah-u Teâlâ’dan utandıkları için
          Allah-u Teâlâ’da onlardan utandı.
        </p>
      </div>

      <div className="paragraph_heading">
        <p>Hz. Hoşea&apos;nın Tebliği</p>
      </div>

      <div className="main_text">
        <p>Hz. Hoşea(as) İsrailoğullarına:</p>
        ...
        <p>Allah-u Teâlâ başka bir vakit yine Hz. Hoşea(as) vasıtasıyla:</p>
        ...
        <p>
          Hz. Hoşea(as) İsrailoğulları arasında dolaşmaya devam ederek nasıl amel
        ...
        <p>O vakit Rabb-i Rahim Hz. Hoşea(as)’ya seslenip;</p>
      ...
      <div className="main_text">
        <p>
          &quot;Allah Celle Celalühü için ağlayan göz ne mübarektir, O&apos;nun
          aşkıyla yanıp kavrulan yürek ne mukaddestir&quot; diyen Mevlana hazretleri
          gibi İsrailoğulları Allah aşkıyla yanıp tutuşacakken dünyevi hevesatları
          ve korkuları, Allah aşkıyla yanmalarına mani oluyordu. Ancak onlar
          nefsani arzularını tatmin etmelerine müsade eden putların aşkıyla yanıp
          tutuşmaktaydılar. Günümüzde de vaziyet böyle değil mi?
        </p>

        <p>
          Allah-u Teâlâ’nın emirlerine riayet etmeyenler, O’nun emirlerini gereksiz,
          saçma, uygulanamaz olarak görseler de birçok saçma adetlerine devam
          etmekte gayretlidirler. Hangisi daha zordur? Allah-u Teâlâ’nın emirlerine
          uymayıp musibetlere maruz kalmak mı, yoksa dünya hayatının her zorluğuna
          rağmen Allah-u Teâlâ’ya itimat etmek mi? Elbette dünya hayatı bizi
          Allah-u Teâlâ’nın emirlerine riayet etmekte zorlayacaktır ancak Allah-u
          Teâlâ’nın merhameti her daim bizimle olacaktır. Ancak dünya hayatının
          zorluklarından dolayı Allah-u Teâlâ’nın emirleriyle amel etmezsek bizi
          Allah-u Teâlâ’nın gazabından kim koruyacaktır?
        </p>
      ...
      <div className="main_text">
        <p className="mb-1">
          <span className="text-yellow-900">Zebur-u Şerif:</span> Hoşea
        </p>

        <p className="my-1">
          <span className="text-yellow-900">İncil-i Şerif:</span> Matta 2:15,
          Romalılar’a Mektup 9:25-26
        </p>
