...
export default function YesayaAlayhissalam() {
  return (
    <main className="stories relative">
      ...
      <div className="font-amiri text-center">
        ...
        <p className="mt-0">(A&apos;raf 35)</p>
      </div>

      <div>
        <p>
          İsrail kavmi Allah-u Teâlâ’nın halkı olarak yaşadığını ileri sürse de
          şeriate göre amel etmemeye, yoksulları, dulları, öksüz ve yetimleri
          görmezden geliyordu. Adaletsiz bir şekilde hayatlarını idame
          ettiklerinden dolayı Allah-u Teâla, Hz. Yeşaya(as) peygambere seslendi.
        </p>

        <p>
          Hz. Yeşaya(as) Allah-u Teâla’dan aldığı vahiyle hak yola dönmesi için
          İsrail kavmine şöyle tebliğde bulundu:
        </p>
        ...
        <p className="boldItalic">
          ...
          <br />
          Oysa sizler Rabbinizi bırakıp medyumlara, falcılara, büyücülere
          danışırsınız.
          <br />
      ...
      <div className="paragraph_heading">
        <p>İsrailoğullarının İnadı</p>
      </div>

      <div className="main_text">
        <p>
          Hz. Yeşaya(as) kavmi tövbeye çağırdığında İsrailoğulları, et yiyip şarap
          içerek:{' '}
          <span className="text-red-600">
            “Nasıl olsa yarın vefat edecekmişiz. Bu herif kime konuşuyor, kime
            ders veriyor? Tek söylediği emir üstüne emir, şeriat üstüne şeriat,
            biraz şuradan biraz buradan”
          </span>{' '}
          diyerek alay ettiler.
        </p>

        <p>Allah-u Teala da Hz. Yeşaya(as)’ya dedi ki:</p>
      ...
      <div className="paragraph_heading">
        <p>Hükümdarın Duası</p>
      </div>

      <div className="main_text">
        <p>
          Halik-i Âlem’in söylediği hâsıl oldu, Asur hükümdarı Kudüs’ün surlarına
          dayanarak o dönemde Kudüs’te hükümdar olan Hizkiya(ra)’yı tehdit etti.
          Hz. Yeşaya(as)’nın söyledikleri yerine gelince Hizkiya(ra) ulaklar
          göndererek Hz. Yeşaya(as)’dan aman diledi.{' '}
          <span className="vitalic">
            “Ey Yeşaya! Bugün yıkım günü, bugün utanç günü. Asur hükümdarı yalnız
            bize hakaret etmedi semayı ve yeri yaratan Halik-i Âlem’e dahi
            küfretti. Niyaz ederiz Kadir-i Külli Şey’e dua et, belki Asur
            hükümdarının ettiği küfürlerden ötürü bize merhamet eder.”
          </span>{' '}
          Bunun üzerine Hz. Yeşaya(as) Allah-u Teâlâ’nın kelamını onlara iletti.{' '}
          <span className="boldItalic">
            “Asur hükümdarının söylediklerinden korkma, alacağı haber üzerine kendi
            diyarına dönecek.”
          </span>{' '}
          Hizkiya(ra) Allah-u Teâlâ’ya dua ettiği vaktin ertesi sabahı bir melek
          Asur hükümdarının ordugahına gidip beş bin askeri telef etti. Asur
          hükümdarı dehşete düşüp Ninova’ya geri döndü. Kendi ilahına ibadet ettiği
          vakitte de evladı tarafından katledilerek can verdi.
        </p>

        <p>
          Hz. Yeşaya(as) halihâzırda putperestlik eden İsrailoğullarını ikaz
          etmeye ve Rabbin kelamını tebliğ etmeye devam etti:
        </p>
        ...
        <p className="vitalic">
          ...
          <br />
          Kelamullah dahi öyle olacak, yapması için gönderdiğim ameli eda etmeden
          dönmeyecek.”
        </p>
      </div>

      <div className="paragraph_heading">
        <p>Allah Merhametlidir</p>
      </div>

      <div className="main_text">
        <p>
          Allah-u Teâlâ çok merhametli olduğundan kavmine merhamet etmeye söz
          verdi. Ahir zamanda Beyt-ül Makdis’in bulunduğu dağın, dağların en
          haşmetlisi olacağını, bütün kavimlerin oraya akın edeceğini söyledi.
          İsrailoğullarının, Kadir-i Külli Şey’in yollarını öğrenebilmeleri,
          şeriate biat edebilmeleri için Kelamullahın Kudüs’e zuhur edeceğini
          belirtti. Öyle ki kavimler arasındaki anlaşmazlık çözülsün, kılıçlar
          kalksın da çekiç, saban demiri olsun, artık kavimler savaş eğitimi
          yapmasın, birbirine kılıç çekmesin. Rabb-i Kerim, tövbe eden herkesi
          kurtarmak niyetindedir. Bu nedenle isyan edip sürgüne giden kavmin
          arasında tövbe edenlerin bulunacağını ve onların bir vakit sonra Kudüs’e
          geri döneceğini beyan etti. Böylelikle İsrail kavmi geri dönüp Allah-u
          Teâlâ’ya hamtlar sunacak, çünkü Allah-u Teâlâ yoksulu, sıkıntı içinde
          olanı ve düşkünü koruyandır.
        </p>

        <p>Allah-u Teâlâ şöyle buyurdu;</p>

        <p className="boldItalic">
          “Ey kulum İsrail, seçtiğim Yakup’un zürriyeti, dostum İbrahim’in
          torunları!
          <br />
          ...
          <br />
          Bakın elim kurtaramayacak kadar kısa, kulağım duymayacak kadar sağır
          değildir.
          <br />
      ...
      <div className="main_text">
        <p>
          Hakikaten de Allah-u Teâlâ yarattığı insanlara karşı derin bir muhabbet
          beslemekteydi. Âdemoğullarının yoldan sapmış olmasına razı değildi. Bu
          sebepten ötürü çok önceden haber verdiği ‘O mesh edilmiş kişiyi’ gönderip
          Âdemoğullarının esfel-i safiline gitmesine mani olacaktı.
        </p>

        <p>
          Rabb-i Rahim’in göndereceği ‘O mesh edilmiş kişinin nasıl olacağına dair
          Hz. Yeşaya(as) şunları söylemiştir:
        </p>
        ...
        <p className="vitalic">
          ...
          <br />
          Yoksullara adaletle hükmedip yeryüzünde ezilenler için dürüstçe karar
          verecek.
          <br />
          ...
          <br />
          Yakup’un zürriyetini geri getirmek, İsrail’i toplamak için O’nu ana
          rahminde biçimlendirdi.
          <br />
          Kavimlerin Nurullah’ı olacak.
          <br />
          Hükümdarlar O’nu görünce ayağa kalkacak, önderler yere kapanacak.
          <br />
          Biline ki Üstadımız artık saklı olmayacak, gözünüzle göreceksiniz O
          Meshedileni.
          <br />
      ...
      <div className="main_text">
        <p>
          Hz. Yeşaya(as) yine başka bir vakit ‘Meshedilecek olan Salih Kul’ için şu
          vahyi Allah-u Teâlâ’dan aldı:
        </p>

        <p className="vitalic">
          “Bakın, kulum başarılı olacak, el üstünde tutulup mümkün mertebe
          yüceltilecek.
          <br />
          ...
          <br />
          Keder içinde vefat ettikten sonra gün ışığını tekrar görecek ve
          amellerinden memnun olacak.
        </p>

        <p className="boldItalic">
          Allah-u Teâlâ diyor ki:
          <br />
          “Salih kulum, birçoklarının günahlarına kefaret olup beşeriyeti ıslah
          edecek. Bundan ötürü O’na galip olanlar arasında mesken vereceğim; çünkü
          hayatını feda etti, isyankârlarla bir sayıldı. Pek çoklarının cürümlerini
          üstüne aldı, isyankârlara da şefaat etti.”
        </p>
      </div>
      ...
      <div className="main_text">
        <p>
          Allah-u Teâlâ sadece korku salmaya çalışmaz. Allah-u Teâlâ’nın korkusu
          O’na hürmet etmeyenleredir. Oysa Allah-u Teâlâ onlara emirlerin vermesinin
          sebebi, günahlarından arınmaları ve böylece Kadir-i Külli Şey olduğunu
          onlara göstermek istemesidir. Allah-u Teâlâ her şeye kadirdir. O’nun
          yapamayacağı hiçbir şey yoktur. Bundan mütevellit yapacaklarını önceden
          haber ederek kavimlerin hazırlanmasını beklemektedir. Allah-u Teâlâ
          Kelamullahın geldiğinde ne amaçla geleceğini önceden bildirerek
          İsrailoğullarını hazırlamaktadır. Kelamullah semadan düşen yağmur gibi
          Allah-u Teâlâ’nın kendisine verdiği vazifeyi eda edecektir. Peki, ben
          Allah-u Teâlâ’nın bana verdiği vazifeyi eda edebiliyor muyum?
        </p>
      </div>
      ...
      <div className="main_text">
        <p className="mb-1">
          ...
          19:1-7, 20-21, 32:20-23
        </p>

        <p className="my-1">
          <span className="text-yellow-900">Zebur-u Şerif:</span> Yeşaya(as)
          Risalesi
        </p>

        <p className="my-1">
          <span className="text-yellow-900">İncil-i Şerif:</span> Matta 3:3, 8:17,
          12:17-18, 13:14, 15:7-8, Markos 1:2, 7:6, Luka 3:4, 4:16-17, Yuhanna
          1:23, 12:38-41, Elçilerin İşleri 8:28-30, 28:25, Romalılar 9:27-29,
          10:16, 20, 15:12
        </p>
