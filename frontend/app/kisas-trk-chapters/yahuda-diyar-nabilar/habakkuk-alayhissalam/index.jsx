...
export default function HabakkukAlayhissalam() {
  return (
    <main className="stories relative">
      ...
      <div className="font-amiri text-center">
        ...
        <p className="mt-0">(İbrahim 47)</p>
      </div>

      <div>
        <p>
          Babil hükümdarı Kudüs’ü fethettiği vakit Hz. Habakkuk(as) dehşet engiz
          hadiseleri seyrettiğinden ötürü ah-u zar edip Kadir-i Külli Şey’e niyaz
          ederek şöyle dedi:
        </p>

        <p className="vitalic">
          “Ya Rab ne zamana dek senin himmetini bekleyeceğiz, niyazımı duymakta
          mısın?
          <br />
        ...
        <p>Allah-ü Teâlâ Hz. Habakkuk(as)’ın niyazına cevap verdi.</p>
        ...
        <p>Hz. Habakkuk(as) duydukları karşısında dehşete düşüp dua etmeye devam etti:</p>
        ...
        <p className="vitalic">
          ...
          <br />
          Neden kavm-i İsrail’i denizin balıklarına, yeryüzünde sürünen mahlûklara
          benzettin?
          <br />
          ...
          <br />
          Ağlarını durmadan atmaya, gaddarlıkla kavimleri katletmeleri sürekli mi
          olacak?”
        </p>

        <p>Ve Allah-u Teâlâ Hz. Habakkuk(as)’a cevap verip şöyle dedi:</p>
        ...
        <p className="boldItalic">
          ...
          <br />
          Bu tutsaklar, kendilerine karşı bir mesel, bir istihzalı laflar
          söylenmeyeceğini mi sanırlar?
          <br />
        ...
        <p>Bunun akabinde Hz. Habakkuk(as) bu ilahiyi söyledi:</p>
      ...
      <div className="main_text">
        <p>
          Allah-u Teâlâ kavmini defalarca kez ikaz etmişti. Lakin İsrailoğulları
          tövbe etmek yerine fenalıklarına devam etmişlerdi. Buna mukabil Allah-u
          Teâlâ Hz. Musa(as) vasıtasıyla söylediği bütün belaları İsrailoğullarının
          başına getirdi. İsrailoğulları artık tövbe etmek istese de artık çok
          geçti. Peki günahlarımdan ötürü musibetler başıma geldiğinde ne etmem
          gerekiyor? İsyan eden nefsimin isyan etmesine devam mı etmem gerekiyor?
          Yoksa “Mevlam neyler, neylerse güzel eyler” deyip günahımın ceremesini
          yaşamaya razı mı göstermem gerekiyor? Her şeye rağmen Allah-u Teâlâ’da
          mesrur olabilir miyim? Her musibete rağmen Allah-u Teâlâ hamd-u senalar
          edebilir miyim?
        </p>
      </div>
      ...
      <div className="main_text">
        <p className="mb-1">
          <span className="text-yellow-900">Zebur-u Şerif:</span> Hz.
          Habakkuk(as)’un Suhufları
        </p>
