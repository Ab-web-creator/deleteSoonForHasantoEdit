...
export default function SefenyaAlayhissalam() {
  return (
    <main className="stories relative">
      ...
      <div className="font-amiri text-center">
        ...
        <p className="mt-0">(En&apos;am 34)</p>
      </div>

      <div>
        <p>
          Hz. Yeremya(as)’nın hayatta olduğu devirlerde Allah-u Teâlâ Hz.
          Sefenya(as) adında bir peygamberi daha seçerek İsrail kavmini ikaz etmesi
          için tebliğ vazifesini vermişti. Hz. Sefenya(as) İsrail kavmine Allah-u
          Teâlâ’nın ikazını şu şekilde iletti;
        </p>
        ...
        <p>Allah-u Teâlâ diyor ki:</p>

        <p className="boldItalic">
          “İnsanları öyle bir felakete uğratacağım ki, körler gibi nereye
          gittiklerini bilmeyecekler.
          <br />
      ...
      <div className="main_text">
        <p>
          Hz. Sefenya(as) bunları dedikten sonra Allah-u Teâlâ şu sözleri ona
          vahyetti bunun akabinde Hz. Sefenya(as) halkın arasında dolanarak
          şunları tebliğ etti:
        </p>
        ...
        <p>
          Nitekim Hz. Sefenya(as)’nın ikazları kayıtsız kaldı. İsrail kavmi tövbeye
          yanaşmadı. Günahlarından vazgeçmedi. Hz. Sefenya(as) da son kez ikaz
        ...
        <p>
          Bu yüzden <span className="boldItalic">“Bekleyin de görün”</span> diyor
          Kadir-i Külli Şey,
        </p>
        ...
        <p className="boldItalic">
          ...
          <br />
          Orayı benim ismime sığınan, yumuşak huylu ve tevazu sahiplerine
          bırakacağım.
          <br />
          O zaman hep birlikte benim ismimi çağırmaları, omuz omuza bana hizmet
          etmeleri için,
          <br />
          ...
          <br />
          Yalan söylemeyecek, kimseyi aldatmayacak ve onları korkutan kimse
          olmayacak.”
        </p>
      </div>

      <div className="paragraph_heading">
        <p>Allah&apos;ın Merhameti</p>
      </div>

      <div className="main_text">
        <p>
          Allah-u Teâlâ her ne kadar İsrail halkına sitem etse de onları tamamen
          gözden çıkarmak istemiyordu. Tüm bu felaketler onların doğru yola dönmesi
          içindi. İsrail kavmini seçmekteki amacı henüz bitmediği için onları tekrar
          Arz-ı Mev’ûd’a getirme niyetindeydi. Bu yüzden Allah-u Teâlâ Hz.
          Sefenya(as) aracılığıyla şunları da halka iletti:
        </p>
        ...
        <p className="boldItalic">
          ...
          <br />
          Allah-u Teâlâ senin cezanı kaldırdı, def etti düşmanlarını. Hükümdarımız
          olan Allah seninle ey İsrail! Korkma fenalıklardan.
          <br />
        ...
        <p>Kadir-i Külli Şey diyor ki:</p>
      ...
      <div className="main_text">
        <p>
          İsrailoğulları her ne kadar vefasız olsa da Allah-u Teâlâ onları bir amaç
          için seçmişti. Bundan dolayıdır ki her daim onlara merhamet etmiştir.
          Onların vazifesi tamamlanana kadar Allah-u Teâlâ her daim muhafaza
          etmekteydi. Bundan mütevellit İsrailoğullarının tekrar Arz-ı Mev’ud’a
          gelip Allah-u Teâla’nın tasarısında yerini almalıydı. Peki, Allah-u
          Teâlâ’nın bu ahirzamanda beni ne ile vazifelendirmiştir? Hz. Yoel(as)
          gibi kıyametin varlığından şüphe edenlere Allah-u Teâlâ’nın sözlerini
          tebliğ etmek değil de nedir benim vazifem? Bunca yıldır kıyametin
          kopmaması, kıyametin gelmeyeceğini mi gösterir yoksa artık kıyamete daha
          da yaklaştığımızı mı gösterir?
        </p>
      </div>
      ...
      <div className="main_text">
        <p className="mb-1">
          <span className="text-yellow-900">Zebur-u Şerif:</span> Sefenya’nın
          Suhufları
        </p>
