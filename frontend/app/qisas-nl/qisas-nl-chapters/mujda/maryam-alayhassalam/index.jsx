...
export default function Maryam() {
    ...
    <main className="stories relative">
      ...
      <article className="flex gap-6">
        <div className="sm:w-1/2">
          <p className='!text-green-600 sm:!text-gray-600 !text-[16px] leading-[15.5px]'>
        ...
        <div className="mt-1 hidden sm:block sm:w-1/2 rtl">
          <p   dir="rtl" 
                  lang="ar" 
                  className="font-amiri !text-[22px] !leading-[44px]">
 ...
 {openBubbles['bubble3'] && (
      ...
      <div className="main_text">
        ...
        <p
          className="boldItalic border p-4 !my-10 rounded-md border-1 border-green-600 cursor-pointer"
 ...
 {openBubbles['bubble5'] && (
      ...
      <div className="main_text">
        ...
        {openBubbles['bubble7'] && (
          ...
          >
            <p>
              <sup>7-8</sup> Қуръоннинг Марям сураси, 19:17-18 оятлар.
            </p>
          </div>
        )}
      </div>
