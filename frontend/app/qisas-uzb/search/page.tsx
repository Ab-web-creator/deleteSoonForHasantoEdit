...
import ButtonSecondary from "@/app/components/BackButton";
import SearchBox from "../components/SearchBoxQisas";
...
const chaptersDir = path.join(process.cwd(), "app/qisas-uzb-chapters");
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-1 text-sm text-[#8b8576]">
                Бу бобда бу сўз {chapter.matchCount} марта зикр қилинибди
              </div>
            </div>
          </Link>
        ))}
        ...
        {query && results.length === 0 && (
         <article className="border rounded-xl px-5 pt-5 pb-10 flex flex-col items-center">
          ...
          <p className="text-lg lg:text-xl text-center text-[#967300]">
            Қидирган сўзингиз топилмади!
          </p>
          <p className="mt-2 text-sm lg:text-md text-center">Бошқа сўзлар билан яна бир бор <br /> уриниб кўринг</p>
         </article>
        )}
      </div>
    </div>
