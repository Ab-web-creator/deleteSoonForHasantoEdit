...
export default function InsideFish() {
  ...
  return (
    <main className="stories relative">
      ...
      <div className="main_text">
        <p className='sm:pl-4 !my-0'>Ўлим оғушида чекдим оҳу-дод, </p>
        <p className='sm:pl-4 !my-0'>Оллоҳим, нажот бер, деб қилдим фарёд. </p>
      </div>

    
      <div className='main_text cursor-pointer' onClick={() => toggleBubble('bubble2')}>
        <p className=" sm:pl-4 !my-0" >
        ...
        <p className='sm:pl-4 !my-0'>Қаро тўлқин вужудимни қуршади. </p>
 
      </div>

      <div className="main_text">
        <p className="sm:pl-20 !mb-0">Тушкунликка тушиб дедим: «Мабодо, </p>
        <p className="sm:pl-20 !my-0">Ҳаёт нафасидан бўлдимми жудо? </p>
        <p className="sm:pl-20 !my-0">Магар энди ибодатлар қилолмам, </p>
        <p className="sm:pl-20 !my-0">Ал-Ақсони зиёрат ҳам этолмам?» </p>
      </div>

      <div className="main_text">
        <p className="sm:pl-4 !mb-0">Пастга тортар эди гирдоб сувлари, </p>
        <p className="sm:pl-4 !my-0">Бўйнимдан бўғарди денгиз ўтлари. </p>
      
        <p className="sm:pl-4 !my-0">Чўкиб Барзақ тубига етган эрдим, </p>
        <p className="sm:pl-4 !my-0">Умид узиб жаҳондан кетган эрдим. </p>
      </div>

      <div className="main_text">
        <p className="sm:pl-20 !mb-0">Ўликлар маскани ичра қамалда </p>
        <p className="sm:pl-20 !my-0">ётардим, эй Оллоҳ, шундай маҳалда</p>
        <p className="sm:pl-20 !my-0">иноят кўрсатиб тутдинг қўлимдан, </p>
        <p className="sm:pl-20 !my-0">мени қутқаздинг-ку мангу ўлимдан. </p>
      </div>

      <div className="main_text">
        <p className="sm:pl-4 !mb-0">Нафасим узилиб, барча умидим </p>
        <p className="sm:pl-4 !my-0">Тугаганда, Оллоҳ, Сени эсладим. </p>
        <p className="sm:pl-4 !my-0">Сени эсладим-у, Сенга дод солдим, </p>
        <p className="sm:pl-4 !my-0">Байтуллоҳга етиб борди дуойим! </p>
      </div>

      <div className="main_text">
        <p className="sm:pl-4 !mb-0">Кимки тавоф этар арзимас бутни, </p>
        <p className="sm:pl-4 !my-0">инкор этар Худо меҳри-лутфини.</p>
        <p className='sm:pl-4 !my-0'>Мен-чи шукур қилиб, айтиб олқишлар, </p>
        <p className="sm:pl-4 !my-0">Сенга қиладурман қурбон-назрлар.</p>
      </div>

      <div className="cursor-pointer" onClick={() => toggleBubble('bubble3')}>
        <p className="sm:pl-4 !mb-0">Қутқарувчи Сенсан, Сендадир ҳаёт, </p>
      </div>

      <div className="main_text">
   
        <p className="cursor-pointer sm:pl-4 !my-0" onClick={() => toggleBubble('bubble3')}>
