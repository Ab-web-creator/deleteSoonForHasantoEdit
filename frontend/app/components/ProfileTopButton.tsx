    ...
    <div ref={wrapperRef} className="relative">
      ...
      <article
        ...
        className="
          ...
          rounded-full p-1 transition-colors hover:bg-[#fffbeb]
        "
      >
        <div className="flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-full bg-stone-200">
          {avatarUrl ? (
            <img
              src={avatarUrl}
              alt="Profile photo"
